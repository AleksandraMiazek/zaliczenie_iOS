...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    let serverUrl: String = "https://79a950dc.ngrok.io" // @TODO: url https z ngrok
    ...
    func parseJson() {
      /* @TODO: uzupełnij ładowanie danych z JSONa do Core Data*/
        ...
        let url = URL(string: serverUrl)
               ...
               {(data, response, error) in
                   ...
                   do {
                       ...
                       if let object = json as? [String:Any] {
                           ...
                           for element  in object as! [Dictionary<String, AnyObject>]{
                               ...
                               let id = element["id"] as! Int
                                ...
                                let description = element ["descritpio"] as! String
                                let image = element ["image"] as! String
                                let location_lat = 50
                                let location_long = 50
                            
                                let produkt = NSManagedObject(entity: self.productsEntity!, insertInto: self.managedObjectContext)
                               produkt.setValue(id, forKey: "external_id")
                                produkt.setValue(product, forKey:"title")
                                produkt.setValue(description, forKey:"descriptio")
                                produkt.setValue(image, forKey:"image")
                                produkt.setValue(location_lat, forKey:"lat")
                                produkt.setValue(location_long, forKey:"long")
                       ...
                       print("to nie jest JSON albo nie mozemy zserializowac JSONa")
